...
<div class="fh5co-loader"></div>
    ...
    <button class="button" onclick="window.location.href = 'pridatspravu'"; style="margin-left: 1600px; margin-top: 5px">Pridať správu</button>
    ...
    <div class="container-wrap2" style="top: 300px">
        ...
        <div class="row">
            ...
            <div class="column" style="position: relative; top: 7px; right: 50px" >
                <a href=""><h2><b>{{$row['nazov_univerzity']}}</b></h2></a>
