...
<p id="Partnerskeuniverzity">
    <div class="container-wrap2">
        <h2><p style="font-style: normal; color: black; position: relative; padding-left: 35px; padding-top: 15px">Malajzia</p></h2>
...
<div style="position: relative; padding-left: 35px; padding-right: 35px; padding-bottom: 35px">
    <table>
        ...
        <tr>
            <td>University of Technology, Johor Bahru/Kuala Lumpur</td>
            <td>2</td>
            <td>doktorský</td>
            <td>ai/izm</td>
            <td>3</td>
...
<p id="prihlaska">
    <div class="container-wrap2">
        <h2><p style="font-style: normal; color: black; position: relative; padding-left: 35px; padding-top: 15px">Prihláška</p></h2>

<p style="font-style: normal; color: black;  position: relative; padding-left: 35px; padding-right: 35px; padding-bottom: 15px; position: center";>

    Přihlášení na mobilitu je možné elektronicky na tomto webu do 29. 11. 2019 (včetně) .
    <br><br>
