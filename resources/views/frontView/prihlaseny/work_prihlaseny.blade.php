            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="fh5co-blog animate-box">
                        <a href="usa_prihlaseny" class="blog-bg" style="background-image: url({{ asset('frontEnd') }}/images/usa1.jpg);"></a>
                        <div class="blog-text">
                            ...
                            <ul class="stuff">
                                ...
                                <li><a href="usa_prihlaseny">Čítajte viac<i class="icon-arrow-right22"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="fh5co-blog animate-box">
                        <a href="taiwan_prihlaseny" class="blog-bg" style="background-image: url({{ asset('frontEnd') }}/images/taiwan.jpg);"></a>
                        <div class="blog-text">
                            <span class="posted_on">Pracovná stáž</span>
                            <h2>Taiwan</h2>
                            ...
                            <ul class="stuff">
                                ...
                                <li><a href="taiwan_prihlaseny">Čítajte viac<i class="icon-arrow-right22"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="fh5co-blog animate-box">
                        <a href="polsko_prihlaseny" class="blog-bg" style="background-image: url({{ asset('frontEnd') }}/images/polsko.jpg	);"></a>
                        <div class="blog-text">
                            <span class="posted_on">Pracovná stáž</span>
                            <h2>Polsko</h2>
                            <p>Wroclaw University of Science and Technology je dlouholetým partnerem naší fakulty.                                                 </p>
                            <ul class="stuff">
                                <li><a href="polsko_prihlaseny">Čítajte viac<i class="icon-arrow-right22"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
