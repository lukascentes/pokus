...
<div class="login">
    <h1>Prihlásiť sa</h1>
    <form method="post">
        <input type="text" name="u" placeholder="Prihlasovacie meno" required="required" />
        <input type="password" name="p" placeholder="Heslo" required="required" />
        <button type="submit" class="btn btn-primary btn-block btn-large">Prihlásiť</button>
    </form>
</div>
