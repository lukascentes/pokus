...
<p style="font-style: normal; color: black;  position: relative; padding-left: 35px; padding-right: 35px; padding-bottom: 15px; position: center";>
    ...
    <br>
    Green fuels and environment;<br>
    Acceptance and Operating Tests of Electrical Installations And Devices;<br>
    Power Quality;<br>
    Programmable Logic Controllers PLC;<br>
    Renewable energy systems in engineering simulations;<br>
    Thermal comfort and renewable energy for low energy buildings;<br>
    Design Thinking for Innovation in 21st Century;<br>
    Renewable energy sources in household and power sector;<br>
    Foundations of Quantum Information and Communication;<br>
    Ceramic microfluidic devices for gas sensing;<br>
    Lab-chip devices assembled with optoelectronics;<br>
    MEMS and mechatronic systems with LabVIEW;<br>
    Microsystems- do you know what the MEMS are?<br>
    Anomalous diffusion models with application to biological data;<br>
